...
New-Shortcut $tools "R-factor test"       "run_rfactor_test.bat" "%SystemRoot%\System32\shell32.dll" 23  "Volume+range wala R-factor sach mein ek hi cheez badalta hai"
...
New-Shortcut $tools "Order safety test"  "run_order_test.bat"  "%SystemRoot%\System32\shell32.dll" 48 "Ek click order nahi bhej sakta - proof"
...
New-Shortcut $tools "Universe check"      "run_universe_test.bat" "%SystemRoot%\System32\shell32.dll" 23  "F&O list purani toh nahi - naam gayab ho rahe hain kya"
